	...
	private void displayOptions() {
		...
		switch (choice) {
			...
			case 3: //Rest
				...
				break;
			case 4:  //Exit
				System.out.println(player.getName() + " trades " + player.getMithril() + " mithril into " + player.getMithril()*5 + " bars of gold!");
				System.out.println(player.getName() + " exits Moria with " + player.getGold()+player.getMithril()*5 + " gold!");
				if ((player.getGold()+player.getMithril()*5) <= 0) {
					System.out.println("You leave empty handed, but at least you survived!");
				} else if ((player.getGold()+player.getMithril()*5) > 100) {
					System.out.println("Decent job, you'll go home with some money and an adventure to tell of.");
				} else if ((player.getGold()+player.getMithril()*5) > 250) {
